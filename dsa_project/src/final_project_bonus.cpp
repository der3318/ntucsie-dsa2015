...
void find_reg_in_rb(struct rb_node *node, char *_p, int &n)
{
	...
	if(data[index].cash != -1 && WildTextCompare(data[index].account, _p))
	{
...
int main()
{
	...
	while(scanf("%s", cmd) != EOF)
	{
		if(cmd[0] == 'l'){
			...
			{	
				printf("Do you mean login?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "login") == 0 || yn[0] == 'Y')
			{
			...
			{	
				printf("Do you mean create?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "create") == 0 || yn[0] == 'Y')
			{
				int flag = check(id, psd);
			...
			{	
				printf("Do you mean delete?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "delete") == 0 || yn[0] == 'Y')
			{	
				int flag = check(id, psd);
				if(flag == -1 || flag == -3)  printf("ID %s not found\n", id);
				else if(flag == -2) printf("wrong password\n");
			...
			{	
				printf("Do you mean merge?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "merge") == 0 || yn[0] == 'Y')
			{
		...
		else if(cmd[0] == 'd' && cmd[1] == 'e' && cmd[2] == 'p'){
			int num = 0; 
			scanf("%d", &num);
			char yn[2];
			if(strcmp(cmd, "deposit") != 0)
			{	
				printf("Do you mean deposit?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "deposit") == 0 || yn[0] == 'Y')
			{
			...
			{	
				char yn[2];
				printf("Do you mean withdraw?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "withdraw") == 0)
			...
			{	
				printf("Do you mean transfer?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "transfer") == 0 || yn[0] == 'Y')
			{
			...
			{	
				printf("Do you mean search?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "search") == 0 || yn[0] == 'Y')
			{
				int flag = check(id, psd_for_check);
				find_rec(flag, id);
			}
			...
			{	
				printf("Do you mean find?(Y/N)\n");
				scanf("%s", yn);
				if(yn[0] == 'N')	printf("input your command again\n");
			}
			if(strcmp(cmd, "find") == 0 || yn[0] == 'Y')	find(pattern);
		}
		else	printf("input your command again\n");
	}
	return 0;
}
